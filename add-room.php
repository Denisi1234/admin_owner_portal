...
<body>
    ...
    <script>
        window.ROOM_EDITOR_CONFIG = {
            isEdit: <?php echo $is_edit ? 'true' : 'false'; ?>,
            roomId: <?php echo $is_edit ? $room['id'] : 'null'; ?>,
            initialPhotos: <?php echo json_encode($photos_arr); ?>,
            apiToken: <?php echo json_encode($_SESSION['api_token'] ?? ''); ?>
        };
    </script>
    <script src="assets/js/custom/room-editor.js"></script>
</body>
</html>
