...
<body>
    ...
    <?php include 'elements/page-js.php'; ?>
        ...
        <!-- Admin Update Payout Status Workflow Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border-radius: 14px;">
                    <form id="form-update-payout">
                        ...
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-secondary font-w600" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" id="btn-submit-payout-update" class="btn btn-primary font-w600"><i class="fas fa-check-circle me-1"></i> Update Status</button>
                        </div>
                    </form>
                </div>
            </div>
